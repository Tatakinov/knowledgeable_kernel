...
\1
\n[half]
ニ○ニ○動画のコメントが滑らかに流れるようになっとるから、
描画周りは改善されてるんとちゃうかな。\n
ただ、SSPがちゃんとは動かなくなってもうた。\n
\0\s[驚き]
\n[half]
えぇー！@どうするのさ！？@\n
\1
\n[half]
ユーザ側で出来ることはあらへんのや。\n
ベースウェア開発者的には方法はあるにはあるんやけど、
Linuxのためだけにそこまでするかというと…っちゅう感じやね。\n
\0\s[落ち込み]
\n[half]
そっかぁ…。\n
]],
...
\1\s[素]
\0\s[素]
パッケージの用意されてないソフトウェアがあるんだけどさ、
ビルド方法がわからないよぐにゅえもん！@\n
\1
変なあだ名を付けるんじゃない。\n
\n[half]
ビルド方法には色々あるからここで紹介するのは割愛するとして、
最低限【README】や【INSTALL】ファイルがあったらしっかり読むべきやね。
作者が手を抜いていなければそこにビルドの仕方が書いてあるはずや。\n
\0
\n[half]
ぬーさん。\n
\1
